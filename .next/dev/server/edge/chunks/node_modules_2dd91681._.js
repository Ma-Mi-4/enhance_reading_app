(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/node_modules_2dd91681._.js",
...
"[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseSupabaseCookie(str) {
    ...
    try {
        ...
        const payload = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$browser$2f$util$2f$base64url$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__base64url$3e$__["base64url"].decode(payloadStr);
        const decoder = new TextDecoder();
...
function createSupabaseClient(supabaseUrl, supabaseKey, options) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(supabaseUrl, supabaseKey, {
        ...options,
        auth: {
            flowType: "pkce",
...
"[project]/node_modules/set-cookie-parser/lib/set-cookie.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@supabase/auth-helpers-nextjs/dist/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var import_auth_helpers_shared = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [middleware-edge] (ecmascript)");
var supabase;
function createClientComponentClient({ supabaseUrl = ("TURBOPACK compile-time value", "https://lvggbhafiasctmmlozuh.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx2Z2diaGFmaWFzY3RtbWxvenVoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM4ODczNTYsImV4cCI6MjA3OTQ2MzM1Nn0.-E-UotgYKIKXQaJyRAfUxkJNzyTgHelOcT5bCA1yh0E"), options, cookieOptions, isSingleton = true } = {}) {
...
var import_auth_helpers_shared2 = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [middleware-edge] (ecmascript)");
var import_set_cookie_parser = __turbopack_context__.r("[project]/node_modules/set-cookie-parser/lib/set-cookie.js [middleware-edge] (ecmascript)");
...
function createPagesServerClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://lvggbhafiasctmmlozuh.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx2Z2diaGFmaWFzY3RtbWxvenVoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM4ODczNTYsImV4cCI6MjA3OTQ2MzM1Nn0.-E-UotgYKIKXQaJyRAfUxkJNzyTgHelOcT5bCA1yh0E"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared3 = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [middleware-edge] (ecmascript)");
var import_set_cookie_parser2 = __turbopack_context__.r("[project]/node_modules/set-cookie-parser/lib/set-cookie.js [middleware-edge] (ecmascript)");
...
function createMiddlewareClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://lvggbhafiasctmmlozuh.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx2Z2diaGFmaWFzY3RtbWxvenVoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM4ODczNTYsImV4cCI6MjA3OTQ2MzM1Nn0.-E-UotgYKIKXQaJyRAfUxkJNzyTgHelOcT5bCA1yh0E"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared4 = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [middleware-edge] (ecmascript)");
...
function createServerComponentClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://lvggbhafiasctmmlozuh.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx2Z2diaGFmaWFzY3RtbWxvenVoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM4ODczNTYsImV4cCI6MjA3OTQ2MzM1Nn0.-E-UotgYKIKXQaJyRAfUxkJNzyTgHelOcT5bCA1yh0E"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared5 = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [middleware-edge] (ecmascript)");
...
function createRouteHandlerClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://lvggbhafiasctmmlozuh.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx2Z2diaGFmaWFzY3RtbWxvenVoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM4ODczNTYsImV4cCI6MjA3OTQ2MzM1Nn0.-E-UotgYKIKXQaJyRAfUxkJNzyTgHelOcT5bCA1yh0E"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = ("TURBOPACK compile-time value", "https://lvggbhafiasctmmlozuh.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx2Z2diaGFmaWFzY3RtbWxvenVoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM4ODczNTYsImV4cCI6MjA3OTQ2MzM1Nn0.-E-UotgYKIKXQaJyRAfUxkJNzyTgHelOcT5bCA1yh0E"), options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://lvggbhafiasctmmlozuh.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx2Z2diaGFmaWFzY3RtbWxvenVoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM4ODczNTYsImV4cCI6MjA3OTQ2MzM1Nn0.-E-UotgYKIKXQaJyRAfUxkJNzyTgHelOcT5bCA1yh0E"), options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://lvggbhafiasctmmlozuh.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx2Z2diaGFmaWFzY3RtbWxvenVoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM4ODczNTYsImV4cCI6MjA3OTQ2MzM1Nn0.-E-UotgYKIKXQaJyRAfUxkJNzyTgHelOcT5bCA1yh0E"), options, cookieOptions } = {}) {
...
//# sourceMappingURL=node_modules_2dd91681._.js.map